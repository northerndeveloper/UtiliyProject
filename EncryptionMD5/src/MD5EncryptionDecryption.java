...
public class MD5EncryptionDecryption {
	 ...
	 public MD5EncryptionDecryption() throws NoSuchAlgorithmException{
	 ...
	 public static void main(String[] args){
		...
		// System.out.println(MD5EncryptionDecryption.DecryptText(MD5EncryptionDecryption.EncryptText("alper")));
		 
		 System.out.println("text to encrypted =  " + "093193");   
		 System.out.println(MD5EncryptionDecryption.EncryptText("093193"));
		 System.out.println("--");
		 
		 System.out.println("text to encrypted =  " + "542122");   
		 System.out.println(MD5EncryptionDecryption.EncryptText("542122"));
		 System.out.println("--");
		 
		 System.out.println("text to encrypted =  " + "200664");   
		 System.out.println(MD5EncryptionDecryption.EncryptText("200664"));
		 System.out.println("--");
